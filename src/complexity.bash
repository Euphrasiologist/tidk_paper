...
# only create the data here if we pass an argument to the script
if [ "$1" != "" ]; then
...
echo "tidk explore -m 5 -x 30 --distance 0.001 ../data/bombus_sylvestris..."
...
echo "tidk explore -m 4 -x 15 --distance 0.001 ../data/bombus_sylvestris..."

time tidk explore -m 4 -x 15 --distance 0.001 ../data/bombus_sylvestris.fa > /dev/null
time tidk explore -m 4 -x 15 --distance 0.001 ../data/bombus_sylvestris2.fa > /dev/null
time tidk explore -m 4 -x 15 --distance 0.001 ../data/bombus_sylvestris3.fa > /dev/null
time tidk explore -m 4 -x 15 --distance 0.001 ../data/bombus_sylvestris4.fa > /dev/null
time tidk explore -m 4 -x 15 --distance 0.001 ../data/bombus_sylvestris5.fa > /dev/null
